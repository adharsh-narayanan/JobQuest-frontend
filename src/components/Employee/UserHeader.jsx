            ...
            >
              ...
              <Offcanvas.Body>
                <Nav className="justify-content-end flex-grow-1 pe-3">
                  ...
                  <Nav.Link><Link  to={'/user/dashboard'} style={{textDecoration:'none',fontSize:'20px',color:"black"}}>Dashboard</Link></Nav.Link>
                  <Nav.Link ><Link  to={'/all-jobs'}style={{textDecoration:'none',fontSize:'20px',color:"black"}}>All Jobs</Link></Nav.Link>
